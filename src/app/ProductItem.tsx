...
const ProductItem = ({ product }: { product: ProductI }) => {
  return (
    ...
    >
      <div className="min-h-[160px] relative overflow-hidden group-hover:shadow-lg shadow-gray-300 w-full">
        <Image className="w-full h-full absolute duration-100  group-hover:scale-110 object-contain" width={300} height={200} src={"/static/imgs/" + product.image} alt="" />
      </div>
